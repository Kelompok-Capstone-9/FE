...
import gif2 from '../../../assets/gif/gif-2.gif'
...
const LandingPageJumbotron = () => {
    return(
        <>
            <div className='row m-0' style={{backgroundColor:'var(--Neutral-White-100)'}}>
                <div className='row d-flex justify-content-between p-0 mb-4'>
                    <div className='col-12 col-md-6 d-flex justify-content-center'>
                        <div className='col-lg-8 col-11 row mt-5 jumbotron-left'>
                            <div>
                                <h1>Find <span style={{color:"var(--primary-700)"}}>the Right Training for</span> Your Healthy Lifestyle!</h1>
                                <p >We believe that everyone has unique needs and preferences when it comes to training. Therefore, we offer a variety of different training programs to meet the needs of each of our customers.</p>
                            </div>
                            <div>
                                <button className='btn ps-lg-5 pe-lg-5 me-3' style={{backgroundColor:'var(--primary-500)', color:'var(--primary-100)'}}>
                                    Log in
                                </button>
                                <button className='btn pe-lg-4 ps-lg-4' style={{color:'var(--primary-500)', borderColor:'var(--primary-500)'}}>
                                    Join Member
                                </button>
                            </div>
                        </div>
            ...
            <div>
                <div className='reach'>
                    <h3 className='p-5 text-center t-3' style={{ color:'var(--primary-600)', fontWeight:'bold'}}>Reach Optimal Health with GoFit!</h3>
                    <img src= {gif2} alt="" style={{width:'100%'}} />
                </div>
            </div>
        </>
    )
